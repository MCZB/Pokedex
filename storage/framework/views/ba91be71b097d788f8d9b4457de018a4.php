    ...
    <div class="container mt-5">
        ...
        <div class="row" id="pokemonCards">
            ...
            <div class="col-md-2 mb-4">
                <div class="card" data-name="<?php echo e($pokemon->name); ?>" data-types="<?php echo e($pokemon->type); ?>">
                    <a href="<?php echo e(route('pokemons.show', $pokemon->id)); ?>" class="text-decoration-none">
                        <img src="<?php echo e($pokemon->sprite); ?>" alt="<?php echo e($pokemon->name); ?>" class="card-img-top" style="width: 100%; height: 100%; object-fit: cover;">
                        <div class="card-body">
                            <h6 class="card-title text-center m-0"><?php echo e(ucfirst($pokemon->name)); ?></h6>
                        </div>
                    </a>
                </div>
            </div>
...
</html><?php /**PATH E:\pokemon\resources\views/index.blade.php ENDPATH**/ ?>